 ...
 *
 * <p>These validations define conditions that a collection or its elements must meet to be
 * considered valid. They are intended as reusable building blocks for common collection-related
 * validation scenarios.
 *
 * <p>All validations returned by this class ensure that the input collection itself is not {@code
 * null}, unless explicitly documented otherwise.
 *
 * @author Jonas Nuber
 */
public final class CollectionValidations {
  ...
  /**
   * Returns a validation that passes only if the collection does not contain any {@code null}
   * elements.
   *
   * @param <T> the type of elements in the collection
  ...
  /**
   * Returns a validation that passes only if all elements in the collection match the given
   * predicate.
   *
  ...
  /**
   * Returns a validation that passes if at least one element in the collection matches the given
   * predicate.
   *
   * @param predicate the predicate that at least one element must satisfy (must not be {@code
   *     null})
   * @param <T> the type of elements in the collection
  ...
  /**
   * Returns a validation that passes only if no element in the collection matches the given
   * predicate.
   *
