...
class NestedRuleBindingTest {
    ...
    void mustSatisfy_ShouldSetValidationUsed_ForBinding(){
        ...
        binding
                .mustSatisfy(DomainValidator.of(Person.class)
    ...
    void validate_ShouldThrowException_WhenCompositeValidatorIsNull() {
        ...
        assertThat(thrown)
                ...
                .hasMessage("No validator was set. Call mustSatisfy(...) or ifPresent(...) before validation");
    }
    ...
    void validateAndThrow_ShouldNotThrowException_WhenValidationSucceeds() {
        ...
        assertThatCode(() -> binding.validateAndThrow(creditCard))
    ...
    void validateAndThrow_ShouldThrowException_WhenValidationFails() {
        ...
        var thrown = catchThrowable(() -> binding.validateAndThrow(creditCard));

        assertThat(thrown)
                .isInstanceOf(InvalidAttributeValueException.class)
                .hasMessage("The field: \"Owner\" is invalid: Validation for class io.github.jonasnuber.valari.Person failed with 1 error(s):\n" +
                        " - Field 'Name': must not be empty\n");
    }
}